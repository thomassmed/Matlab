function bur_listbox_callback(src,~,hfig)
...
toplistvalue=get(CmsCoreProp.handles.bur_listbox,'ListboxTop');

ival=get(src,'Value');
ibun=CmsCoreProp.isort(ival);
set(CmsCoreProp.handles.data_listbox,'value', ival,'ListboxTop',toplistvalue);
