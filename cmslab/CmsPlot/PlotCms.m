...
function varargout=PlotCms(filename,matvar,varargin)

if nargin==0
    [filename,pathname]=uigetfile({'*.res;*.mat;*.hms;*.h5;*.hdf5;*.out;*.sum;*.dat;*.cms',...
        'CMS-files (*.cms,*.res,*.mat,*.hms,*.h5,*hdf5,*.out,*.sum,*.dat)';...
        '*.cms','cms-files (*.cms)';...
...
h(3,2)=uimenu(h(3,1),'label','max','callback','set_cmsplot_prop operator max;cmsplot_now');
h(3,3)=uimenu(h(3,1),'label','average','callback','set_cmsplot_prop operator mean ;cmsplot_now');
h(3,4)=uimenu(h(3,1),'label','min','callback','set_cmsplot_prop operator min;cmsplot_now');
h(3,5)=uimenu(h(3,1),'label','minmax','callback','set_cmsplot_prop operator minmax;cmsplot_now');
h(3,9)=uimenu(h(3,1),'label','axial offset','callback','set_cmsplot_prop operator aocalc;cmsplot_now');
...
h(3,9)=uimenu(h(3,1),'label','Show Data Labels');
h(3,11)=uimenu(h(3,9),'label','None','callback','set_cmsplot_prop datalabels none;cmsplot_now');
h(3,10)=uimenu(h(3,9),'label','All','callback','set_cmsplot_prop datalabels all;cmsplot_now');
...
h(4,3)=uimenu(h(4,1),'label','show nhyd','callback','set_filter(''nhyd'')');
h(4,4)=uimenu(h(4,1),'label','show nfta','callback','set_filter(''nfta'')');
h(4,5)=uimenu(h(4,1),'label','show label','callback','set_filter(''label'')');
...
h(5,17)=uimenu(h(5,1),'label','Labels');
h(5,18)=uimenu(h(5,17),'label','ij','callback','setprop(1,''IJ'');goplot;');
h(5,19)=uimenu(h(5,17),'label','AXIS','callback','setprop(1,''AXIS'');goplot;');
...
h(6,9)=uimenu(h(6,1),'label','Nodplane','callback','set_node_plane;');
% h(6,10) is occupied in cmsplot_init
h(6,12)=uimenu(h(6,1),'label','surf','callback','DJsPlot');
