...
stabn.eqp=sym_full(reshape(stab.et(ibast+5),kmax,ncc),knum);
...
j_upl_bas=sum(geom.nsec(1:4)*2)+(0:4:(geom.nsec(6)*4-1));
...
load(matfil_old,'stab','geom','steady','msopt')
%%
k=geom.k;
r=geom.r;
e=stab.e;
