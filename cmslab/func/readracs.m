function [description,signals,data,lab,unt,lolim,hilim,gain] = readracs(filename,kpunktname)
% readracs - Reads racs files 
% 
% ds = readracs(racsfile)
% [description,signals,data,lab,unt,lolim,hilim,gain] = readracs(racsfile)
% kpunkt=readracs(racsfile,kpunktname)
%
% Input: 
