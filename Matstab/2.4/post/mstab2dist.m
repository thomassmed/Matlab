function dist=mstab2dist(e,distfil,isym)
% dist=mstab2dist(e,distfil)
% dist=mstab2dist(e,distfil,isym)
% alfa_dist=mstab2dist(alfa,distfil)
%
...
%@(#)   mstab2dist.m 1.8   02/02/27     12:13:36
