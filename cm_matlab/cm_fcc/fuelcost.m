%@(#)   fuelcost.m 1.6	 98/04/02     10:15:30
%
%function [TWh,orekWhtot]=fuelcost(distfil1,distfil2,TWh,prifil,batchfil,freefil);
%function [TWh,orekWhtot]=fuelcost(distfil1,distfil2,TWh,prifil,batchfil,mulfree);
...
%         prifil - Resultfile, default='fuelcost.lis', if 0 is given, the
...
%          fuelcost('eoy-92','eoc8',3.864,0,0,0) % gives fuel cost with no reduction
...
elseif fid>0,
  ...
  fprintf('\n%s\n\n','Result is printed on fuelcost.lis');
  prifil='fuelcost.lis';
  fid=fopen(prifil,'w');
end
