%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Autotip_tiputan_top.m v1.0
% Detta är ett underprogram till Autotip_XP
% function Autotip_utan_top('tipfil',utskrift,tip_infofil)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Autotip_utan_top(tipfil,tip_infofil)
if nargin<2
  reakdir=findreakdir;
...
tipgam=tipgam/mgam;
fel=tipgam-tipmea;
nodav=100*std(fel(:));      % Har valt att ej skriva ut dessa.
radav=100*std(mean(fel));   % Har valt att ej skriva ut dessa.
axav=100*std(mean(fel'));   % Har valt att ej skriva ut dessa.
%
% Text
%
temp_handle=figure;
