%@(#)   manad3f3.m 1.2	 07/08/06     14:54:43
%
%function manad3f3(block,manad)
%
%ex. manad3f3('f2','1996-08')
function manad3f3(block,manad)
...
% -1/720 är borttaget för det gjorde så att programmet inte
% funkade av någon outgrundlig anledning. Behöver kanske fixas då det är
% skottår?
...
set(gca,'box','off')
xlabel(mname)
title('260KW917 Min termisk marginal                                      ')
ylabel('%')
